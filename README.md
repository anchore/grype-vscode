...
This plugin will invoke Grype, a scanner that will check the contents of your current project for packages and artifacts containing known vulnerabilities.
